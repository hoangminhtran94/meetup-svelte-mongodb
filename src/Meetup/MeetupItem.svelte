...
<article class="flex flex-col gap-3">
	<div class="flex gap-3 justify-end px-3">
		{#if meetup.createrId === $page.data.user?.id}
			<button
				class="py-3 hover:scale-110 transition-all"
...
<style>
	article {
		box-shadow: 0 2px 40px rgba(254, 239, 118, 0.26);
		border-radius: 5px;
		background-image: url('/grid-item.svg');
